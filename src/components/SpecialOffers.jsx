...
const SpecialOffers = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-gray-700 via-gray-800 to-black text-white">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl font-extrabold mb-8">Special Offers</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {offers.map((offer, index) => (
            <motion.div
              key={index}
              className="bg-gradient-to-t from-gray-900 via-gray-800 to-gray-700 text-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300"
            ...
            >
              <div className="p-6">
                ...
                <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-2 px-4 rounded-full transition duration-300">
                  {offer.buttonText}
                </button>
              </div>
            </motion.div>
